...
// Fabric-api removed its extended screen handler API in 26.1 and vanilla menus carry no extra data, so this is sent
// right before player.openMenu and stashed until the client menu factory consumes it. Connection ordering guarantees it
// is handled before the open screen packet.
public class ClientBoundOpenExtendedMenuMessage implements Message {
    ...
    //called by the client menu factory when the open screen packet arrives right after this message
    @Nullable
