...
public class ClientHooksMixin {
    ...
    //route neoforge's entity spectator shader through the group system so it stacks with other mods' effects
    //instead of owning vanilla's single post effect slot
