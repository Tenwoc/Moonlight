...
/**
 * Exposes a SoftFluidTank through NeoForge's transfer API. Soft fluids only hold whole
 * bottles (250 mB each), so anything below that granularity is rounded down and never moved.
 */
