...
final class SchemaForm {
    ...
    // only for the two registries whose ids ARE the icon. Anything else (entity types, effects, tags) would leave
    // most rows blank while still paying for the taller row
    @Nullable
