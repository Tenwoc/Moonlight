...
public class MapDataInternal {
    ...
    /**
     * Map data is codec serialized now, so markers and custom data ride along by wrapping vanilla's codec
     * instead of hooking a save/load method. The extra keys go through nbt, which is what
     * CustomMapData speaks and what the save format is anyway.
     */
