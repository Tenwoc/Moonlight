 ...
 * below, plus a hex field and live preview underneath (a ColorFieldWidget whose swatch is a passive preview).
 * On Done it hands the chosen ARGB color back through onApply and returns to parent; on Cancel it
 * just returns to parent. Colors are ARGB ints; with hasAlpha false the alpha slider is hidden and
