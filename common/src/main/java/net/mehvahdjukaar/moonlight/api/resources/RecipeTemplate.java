...
public class RecipeTemplate {
    ...
    /**
     * Registers a recipe type whose remapping is fully described by its ingredients and its result.
     * 26.1 dropped the generic Recipe.getIngredients/getResultItem, so the accessors
