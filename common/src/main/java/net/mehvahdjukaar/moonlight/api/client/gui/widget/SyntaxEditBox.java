...
/**
 * A MultiLineEditBox that renders its text through a per-line SyntaxHighlighter, where vanilla only
...
public class SyntaxEditBox extends MultiLineEditBox {
    ...
    public SyntaxEditBox(Font font, int x, int y, int width, int height, Component placeholder,
        ...
        // vanilla's ctor went private behind a builder that can't produce a subclass, so it is access widened
