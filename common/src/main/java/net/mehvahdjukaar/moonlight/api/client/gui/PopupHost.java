...
/**
 * A screen that can float Popups above its content. It owns an OverlayLayer, forwards its
 * render/mouse/key/char events to it first so popups sit on top, and clears it in init(). Widgets that need
