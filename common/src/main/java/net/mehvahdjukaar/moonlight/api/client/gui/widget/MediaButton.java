...
public class MediaButton {
    ...
    /**
     * A logical button slot the remote allow-list can toggle. Mostly 1:1 with a MediaIcon, except
     * SERVER, a single slot whose icon is chosen per host. A type missing from the hub config's allow-list
     * isn't shown.
     */
    ...
    public static final Identifier YES = Moonlight.res("yes");
     ...
     * int, int), or to an invisible placeholder of the same size when no partner is
     ...
     * no partner is configured, in which case callers skip the slot or fall back to akliz.
     */
    @Nullable
     ...
     *
     * @param adder typically screen::addRenderableWidget
     */
