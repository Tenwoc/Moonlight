 ...
 * <p>
 * The expanded list is a Popup so it can float above a scissored parent (see OverlayLayer). Any
 * screen hosting a dropdown just has to be a PopupHost; the widget opens itself through its layer on click.
 */
public class DropdownWidget extends AbstractWidget implements Popup {
    ...
    public void renderPopup(GuiGraphicsExtractor graphics, int mouseX, int mouseY) {
        ...
        // a stratum of its own so the whole popup sorts above the list rows and their item icons
