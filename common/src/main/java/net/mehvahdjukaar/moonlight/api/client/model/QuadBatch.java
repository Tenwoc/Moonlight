...
/**
 * A recorded run of quads, replayed later with QuadEmitter.emitAll. Meant for
 * geometry that is expensive to build and does not change often, so it survives chunk rebuilds.
 * <p>
 * Unlike caching a list of baked quads it keeps per vertex colors and normals, which a vanilla
 * net.minecraft.client.resources.model.geometry.BakedQuad cannot hold on Fabric.
 */
