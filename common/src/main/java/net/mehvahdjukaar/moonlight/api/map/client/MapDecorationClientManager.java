...
public class MapDecorationClientManager {
    ...
    /**
     * Applied on top of the pose every map decoration is drawn with, vanilla ones included. Set it
     * around your own net.minecraft.client.renderer.MapRenderer calls when you draw maps at a
     * scale or rotation of your own, then clear it. Not persistent, and only meaningful on the render thread
     */
    ...
    /**
     * Draws one extracted decoration, sprite and name, the same way vanilla lays its own out
     *
     * @param index stacking order, offsets the sprite towards the viewer so markers don't z fight
     */
    ...
    /**
     * Draws a decoration sprite centered on the origin, sized like a map marker. Use it to show a
     * marker outside of a map, on a gui button for instance
     */
    ...
    /**
     * How map decorations should be transformed on top of their normal placement
     */
